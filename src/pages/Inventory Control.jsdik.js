...
import {
  ...
  archiveAircraft,
  saveAircraftChild,
  archiveAircraftChild,
  smartSyncAircraft,
  getCabinNormalizationPreview,
  searchInventoryProvider,
  getInventoryProviderResource,
  importInventoryProviderResource,
  refreshInventoryProviderResource,
  listInventoryNegotiatedRates,
  getInventoryNegotiatedRate,
  createInventoryNegotiatedRate,
  updateInventoryNegotiatedRate,
  deleteInventoryNegotiatedRate,
  listAssetLibrary,
  checkAssetLibraryDuplicate,
  prepareAssetLibraryUpload,
  finalizeAssetLibraryUpload,
  getAssetLibraryAccessUrl,
  registerAssetLibraryUsage,
...
const VERSION="B-011.INVENTORY-RUNTIME-2";
