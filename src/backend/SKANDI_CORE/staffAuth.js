...
const ALTEA_APPS = Object.freeze([
  Object.freeze({ id:"altea", title:"ALTEA Reservation Desktop Web (ARDW)", description:"Create and service passenger name records, air segments, ancillary services, and customer itineraries.", icon:"plane", code:"RESERVATIONS", accent:"#005eb8", path:SITE_MAP.alteaReservations, groups:Object.freeze(["sales","operations","occ","destination","system-admin"]) }),
  Object.freeze({ id:"inventory-control", title:"ALTEA Inventory", description:"Manage SKANDI flight, product, capacity, aircraft and inventory controls.", icon:"inventory", code:"INVENTORY", accent:"#006f8f", path:SITE_MAP.inventoryControl, requiredApp:"inventory-control", groups:Object.freeze(["inventory","system-admin"]) }),
