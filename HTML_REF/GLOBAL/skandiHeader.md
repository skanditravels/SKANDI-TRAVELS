...
[siteMap.js](https://github.com/user-attachments/files/32395425/siteMap.js)
```
// src/public/siteMap.js
// SKANDI canonical route + global chrome/auth-popup registry — B-011.31 / Global Header B-011.18.4
...
export const APP_ROUTES = Object.freeze({
  bookingFlow: "/booking",
  myProfile: "/my-profile?section=profile&view=details",
  myClub: "/my-profile?section=club&view=overview",
  myTrips: "/my-profile?section=trips&view=upcoming",
  mySaved: "/my-profile?section=profile&view=saved",
...
[masterPage.js](https://github.com/user-attachments/files/32395441/masterPage.js)
```
// masterPage.js
...
const MASTER_VERSION = "BACKEND-BASE-1.0-B011.18.4-GLOBAL-CHROME";
  ...
  customer: Object.freeze({
    header: Object.freeze({
      ...
      accountNav: Object.freeze([
        { id:"myProfile", label:"My Profile", path:APP_ROUTES.myProfile },
        { id:"myTrip", label:"My Trips", path:APP_ROUTES.myTrips },
        { id:"club", label:"My Club", path:APP_ROUTES.myClub }
      ])
    }),
      ...
      columns: Object.freeze([
        {
          ...
          links:Object.freeze([
            ...
            { label:"Manage your booking", path:APP_ROUTES.myTrips },
        ...
        },
        {
          ...
          links:Object.freeze([
            ...
            { label:"Log In to My Club", path:APP_ROUTES.myClub },
...
async function handleMasterMessage(embed, message = {}) {
  ...
  if (type === "MASTER_CONFIG_REQUEST" || type === "SKANDI_MASTER_CONFIG_REQUEST") {
    ...
    // Global customer header geometry is an invariant, not a suggestion.
    // Any child request is normalized back to the canonical 118px envelope.
    if (source === CUSTOMER_HEADER_SOURCE) {
      try { if ("height" in embed) embed.height = 118; } catch (_) {}
      return true;
    }
...
$w.onReady(async function () {
  ...
  // Keep the public SKANDI header inside its canonical 118px Wix component
  // before any embed messages are processed.
  try { if (header && "height" in header) header.height = 118; } catch (_) {}
